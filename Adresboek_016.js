...
function AdresRecord() { // Object definitie
    
    this.initialiseren = function() {
...
*/
        var formulier = document.getElementById("invoerFormulier");
        if (this.valideerInput(formulier)) {
    ...
    */
    ...
    this.valideerInput = function(formulier) {
    ...
    this.verwijderen = function() {
        ...
        if (echtVerwijderen) {
            ...
            this.bewaarAdressen(); // bewaar de adressen zodat de verwijdering vastgelegd is.
            this.mutFormulierVerbergen();
            
        }
    }
    
    this.sorteer = function(sorteersleutel) { // Sorteermethode: Straight Sort
        ...
        this.bewaarAdressen(); // leg deze verandering vast
    }
    ...
    {               
        (function(index){
            ...
            groepAdressen[i].onclick = function(){            
                ...
                adres.muteren(); //muteren maakt gebruik van de globale variabele adresNode
            }
